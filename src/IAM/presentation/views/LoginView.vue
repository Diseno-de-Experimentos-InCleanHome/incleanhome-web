...
async function handleLogin() {
  ...
  error.value = "";
  try {
    const result = await AuthenticationService.login(form.value);
...
.legal-links { text-align: center; margin-top: 0.75rem; font-size: 0.8125rem; color: #7A8FA6; }
.legal-link { color: #7A8FA6; text-decoration: none; }
.legal-link:hover { color: #009960; text-decoration: underline; }
